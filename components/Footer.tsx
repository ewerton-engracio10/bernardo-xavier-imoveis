      ...
      <div className="container footer-grid">
        ...
        <div>
          ...
          <div className="contact-actions">
            <a className="contact-button" href={siteConfig.instagram.url} target="_blank" rel="noreferrer" aria-label="Abrir Instagram de Bernardo Xavier Imóveis">
              <span className="contact-icon"><InstagramIcon /></span>
              <span>{siteConfig.instagram.handle}</span>
            </a>
            <a className="contact-button" href={whatsappUrl()} target="_blank" rel="noreferrer" aria-label={`Chamar Bernardo no WhatsApp ${siteConfig.whatsapp.display}`}>
